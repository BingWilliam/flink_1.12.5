...
public class CliFrontend {
    ...
    PackagedProgram buildProgram(final ProgramOptions runOptions, final Configuration configuration)
        ...
        // TODO: 12/12/2021 主类，一般在使用 flink run 的时候会指定运行主类，否则不指定的话，就从 mainfest 中解析
        // Get assembler class
        String entryPointClass = runOptions.getEntryPointClassName();
        File jarFile = jarFilePath != null ? getJarFile(jarFilePath) : null;

        /***************************************************************************************
         * TODO 设置主类：.setEntryPointClassName
         *
         */
    ...
    public int parseAndRun(String[] args) {
        ...
        // TODO: 12/12/2021 获取一个参数：Flink run 命令中的 Run 命令 
        // get action
    ...
    public static void main(final String[] args) {
        ...
        // TODO: 12/12/2021 打印输出一些环境信息 
        EnvironmentInformation.logEnvironmentInfo(LOG, "Command Line Client", args);

        // TODO: 12/12/2021  通过 FLINK_CONF_DIR 变量找到 conf 目录
        // 1. find the configuration directory
        final String configurationDirectory = getConfigurationDirectoryFromEnv();

        // TODO: 12/12/2021 解析 conf 目录下的 flink-conf.yaml 配置文件
        // 2. load the global configuration
        final Configuration configuration =
                GlobalConfiguration.loadConfiguration(configurationDirectory);

        // TODO: 12/12/2021 加载：FlinkYarnSessionCli 和 DefaultCli
