...
public class StreamGraphGenerator {
    ...
    public StreamGraph generate() {
        // TODO: 15/12/2021 构建一个 streamGraph
        streamGraph = new StreamGraph(executionConfig, checkpointConfig, savepointRestoreSettings);

        shouldExecuteInBatchMode = shouldExecuteInBatchMode(runtimeExecutionMode);
        // TODO: 15/12/2021 给 streamGraph 添加属性
        configureStreamGraph(streamGraph);

        // TODO: 15/12/2021 初始化一个容器用来存储已经转换过的 Transformation
        alreadyTransformed = new HashMap<>();

        /***************************************************************************************
         * TODO 执行各种算子的 transformation ：由算子生成 transformation 来构建 StreamGraph
         *  当时在执行 各种算子的时候，就已经把算子转换成对应的 transformation 放入 transformations 集合中了
         *  自底向上（先遍历 input transformations）对转换树的每个 transformation 进行转换
         */
        for (Transformation<?> transformation : transformations) {
            // TODO: 15/12/2021 从 Env 对象中，把 Transformation 拿出来，然后转换成 StreamNode
            // TODO: 15/12/2021 Function ---->  Operator ---> Transformation ----> StreamNode
        ...
        /***************************************************************************************
         * TODO
         *  把生成好的 StreamGraph 引用给返回对象，然后清空 保持当前的 StreamGraphGenerator 依然是一个空的
         *  可再生利用
         */
    ...
    /**
     * todo 对具体的一个 transformation 进行转换，转换成 StreamGraph 中的 StreamNode 和 StreamEdge
     * todo 返回值为该 transform 的 id 集合，通常大小为 1 个 （除 FeedbackTransformation）
    ...
    private Collection<Integer> transform(Transformation<?> transform) {
        // TODO: 15/12/2021 已经转换 Transformation 会放在这个集合中
        ...
        if (transform.getMaxParallelism() <= 0) {
            // TODO: 15/12/2021 如果 MaxParallelism 没有设置，使用 job 的 MaxParallelism
        ...
        // TODO: 15/12/2021 如果是 MissingTypeInfo 类型（类型不确定），将会触发异常
    ...
    private Collection<Integer> translate(
        ...
        // TODO: 15/12/2021  StreamNode 的 ID 的集合
        ...
        // TODO: 15/12/2021 创建 context 其中 包含  streamGraph，slotSharingGroup，configuration 信息
        final TransformationTranslator.Context context =
                new ContextImpl(this, streamGraph, slotSharingGroup, configuration);

        // TODO: 15/12/2021  根据不同的模式进行 流或批处理
