...
public class StreamGraph implements Pipeline {
    ...
    public <IN, OUT> void addOperator(
        ...
        // TODO: 15/12/2021 添加一个 StreamNode
        addOperator(
                vertexID,
                slotSharingGroup,
                coLocationGroup,
    ...
    private void addEdgeInternal(
        ...
        if (virtualSideOutputNodes.containsKey(upStreamVertexID)) {
            ...
            // TODO: 15/12/2021 找到该 StreamNode 的上游顶点
            StreamNode upstreamNode = getStreamNode(upStreamVertexID);
            // TODO: 15/12/2021 找到该 StreamNode 的下游顶点
            StreamNode downstreamNode = getStreamNode(downStreamVertexID);

            /***************************************************************************************
             * TODO 如果没有设置 Partitioner
            ...
            // TODO: 15/12/2021  Shuffle 模式
            if (shuffleMode == null) {
                shuffleMode = ShuffleMode.UNDEFINED;
            }

            // TODO: 15/12/2021 构建StreamNode 之间的 边（StreamEdge） 对象
            StreamEdge edge =
                    new StreamEdge(
                            upstreamNode,
                            downstreamNode,
            ...
            // TODO: 15/12/2021 给上游 StreamNode 设置出边
            getStreamNode(edge.getSourceId()).addOutEdge(edge);
            // TODO: 15/12/2021 给下游 StreamNode 设置入边
