...
public class SocketWindowWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /***************************************************************************************
         * TODO  获取StreamExecutionEnvironment
         *
         *
         */
        ...
        /***************************************************************************************
         * TODO 加载数据得到 数据抽象：DataStream
         *  其实最终，只是创建一个 DataStreamSource 对象，然后把 SourceFunction（StreamOperator）和 StreamExecutor Environment
         *  设置到 DataStreamSource 中，DataStreamSource 是 DataStream 的子类
         *  -
         *  DataStream 的主要分类：
        ...
        DataStream<WordWithCount> windowCounts =
                text.flatMap(
                        ...
                        // TODO: 12/12/2021  依然创建一个 DataStream（keyedStream）
