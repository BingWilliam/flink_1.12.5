...
public class HighAvailabilityServicesUtils {
    ...
    public static HighAvailabilityServices createHighAvailabilityServices(
        ...
        // TODO 获取HA 模式，一般，我们都是设置 zookeeper 模式
        // TODO 在flink-conf.yaml 配置文件中，我们会去配置：high-availability = zookeeper
        ...
        switch (highAvailabilityMode) {
            ...
            case ZOOKEEPER:
                // TODO 获取BlobStoreService
                BlobStoreService blobStoreService =
                        BlobUtils.createBlobStoreFromConfig(configuration);

                // TODO 创建 ZookeeperHaServices
                // TODO 对象内部，包装一个 Zookeeper 的实例对象
                // TODO 内部的zk代码实现：用的 curator
                return new ZooKeeperHaServices(
