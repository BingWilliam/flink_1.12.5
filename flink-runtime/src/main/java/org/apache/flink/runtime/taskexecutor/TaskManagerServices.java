...
public class TaskManagerServices {
    ...
    public static TaskManagerServices fromConfiguration(
         ...
         *  Flink 运行的是 流式任务：StreamTask（OperatorChain Pipeline 输入数据，调用 Transformation 执行，输出结果）
         */
        final TaskEventDispatcher taskEventDispatcher = new TaskEventDispatcher();

        /***************************************************************************************
         * TODO 初始化 IOManagerAsync
         *  启动一定数据量的 WriteThread 和 ReaderThread
         *
         */
        ...
        /***************************************************************************************
         * TODO shuffleEnvironment = NettyShuffleEnvironment
         *  上游 StreamTask 和下游 StreamTask 有 Shuffle 动作。
         *  在这个动作过程中，肯定需要很多的一些组件来为其服务，现在创建的这个 NettyShuffleEnvironment 对象
         *  为将来的 Shuffle 提供各种组件创建的支撑。
         */
        ...
        /***************************************************************************************
         * TODO BroadcastVariableManager = BroadcastVariableManager 广播
         *
         */
        final BroadcastVariableManager broadcastVariableManager = new BroadcastVariableManager();

        /***************************************************************************************
         * TODO 初始化 taskSlotTable = taskSlotTableImpl
        ...
        /***************************************************************************************
         * TODO 初始化 jobLeaderService （jobMaster）
         *
         */
