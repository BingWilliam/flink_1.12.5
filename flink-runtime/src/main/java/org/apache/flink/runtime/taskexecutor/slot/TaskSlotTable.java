...
/**
 * TODO 维护这个 TM 上所有的 TaskSlot 与 Task、job 的关系
 * TODO 维护这个 TM 上所有 TaskSlot 的状态；
 * TODO TaskSlot 在执行 allocate/free 操作，通过 TimeService 做超时检测
 *
 * TODO 当一个 slot 被调度执行一个 task，就会生成一个 TaskSlot 对象
 *
 * TODO 关于 Slot 的管理，SlotManagerImpl 主节点启动的时候，已经启动了这个组件
 *
