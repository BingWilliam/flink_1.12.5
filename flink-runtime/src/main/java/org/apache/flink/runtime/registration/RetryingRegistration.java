                                    ...
                                    if (result instanceof RegistrationResponse.Success) {
                                        ...
                                        completionFuture.complete(
                                                RetryingRegistrationResult.success(
                                                        gateway, success));
                                        /***************************************************************************************
                                         * TODO taskExecutor 向ResourceManager 注册成功后，就应该要做的一件事；
                                         *  应该开始隔间发心跳！
                                         *  Flink 集群 和 HDFS 集群不太一样
                                         *  1、HDFS：DataNode 主动给 NameNode 发送心跳
                                         *  2、Flink：ResourceManager 先向 taskExecutor 发送心跳请求。
